  ...
  return (
    <div>
      <Container>
        ...
        <br />
        <hr />
        <h1 className="text-black text-center mb-5">Shipping Rate</h1>
        <Row>
          <Col md={6} className="productWrapper">
            <Card style={{ width: "25rem", backgroundColor: "#09B3B0", padding: "20px", margin: "auto" }}>
              <Card.Body mt-2>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  ...
                  <Form.Group className="mb-3">
                    ...
                    <Button variant="outline-success bg-white text-primary" className="mt-4">Check!</Button>
                  </Form.Group>
                </Card.Subtitle>
              </Card.Body>
            </Card>
          ...
          <Col md={6} className="productWrapper mt-5">
            <div className="checkPriceShipping flex-d m-auto p-3">
                ...
                <p>Hanya hitungan beberapa detik saja Anda sudah bisa menghitung biaya kirim untuk beberapa ekspedisi</p>
            </div>
          </Col>
        </Row>
      </Container>
